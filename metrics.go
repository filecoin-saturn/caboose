...
var (
	...
	sentinelCidCallsTotalMetric = prometheus.NewCounterVec(prometheus.CounterOpts{
		Name: prometheus.BuildFQName("ipfs", "caboose", "sentinel_cids_total"),
	}, []string{"error_status"})
)
...
func init() {
	...
	CabooseMetrics.MustRegister(sentinelCidCallsTotalMetric)
